...
public class MainWrapper {
	...
	// 문제. 공공데이터포털(data.go.kr)에서 "한국전련공사_전기차 충전소 운영정보" API 신청하고 
	// 결과를 "C:/storage/한국전력공사_전기차_충전소_운영정보.xml"로 저장
    ...
    String serviceKey = "Ps9JhP9mIDtejNLHgicY/V4uaTaF/438tMx8aBd+gZY/98dR7k+QxyFfYdVkC2eoTuhmcRqdlnlRlSFQBcy7DQ==";
		String pageNo ="1";
		String numOfRows ="10";
		...
		sb.append("&addr=").append(URLEncoder.encode(addr,"UTF-8")); //그냥 다 인코딩해라
