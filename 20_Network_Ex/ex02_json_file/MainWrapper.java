	...
	public static void ex01() {
	 ...
	 public static void ex02() {
	    ...
	    try {
	      ...
	      //{"rss":{"channel":{"item"......
	      // 키값 rss, {}로 이루어진 JSONObject 구조인 것 확인가능
	      
	      // JSON 가져오는 법
	      // (JSONPbject) obj.get("rss")
	      // obj.getJSONObject("rss") <--권장하는 방법
	      
	      JSONObject rss = obj.getJSONObject("rss");
	      // {"channel":{"item":{"author": ... (rss는 사라짐)
	      JSONObject channel = rss.getJSONObject("channel");
	      // {"item":{"author":"기상청","link": ... (channel 사라짐)
	      JSONObject item = channel.getJSONObject("item");
	      // {"author":"기상청","link":"http://www.kma.go.kr/weather/forecast/mid-term_01.jsp", ...
	      JSONObject description = item.getJSONObject("description");
	     
	      System.out.println(rss.toString()); //rss, channel,item,description 바꿔가면서 실행해서 확인해보면 됨
	      System.out.println(description.toString());
	      // {"header":{"wf":202308070600,"title":"전국 육상중기예보","wf":"○ (강수) 10일(목) ...
