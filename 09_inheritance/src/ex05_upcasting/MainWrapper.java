...
public class MainWrapper {
  ...
  public static void main(String[] args) {
    ...
    Person p1 = new Student("고길동", "강원대학교"); //자식 객체를 부모 타입으로 저장
    Person p2 = new Alba("홍길동", "가산대학교", "투썸");
    // 서로 다른 타입의 Student와 Alba를 하나의 타입 Person으로 관리할 수있음
    
    p1.eat();
    p1.sleep();
    p1.study(); //person에 있어야 호출할 수 있으니 person에 study 넣어주고 student에서 오버라이드하면 person으로도 사용할 수 있어짐
